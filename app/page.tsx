      ...
      <section className="mx-auto flex max-w-4xl flex-col gap-8">
        <div className="flex flex-col gap-4">
          <p className="text-sm font-semibold uppercase tracking-wide text-orange-600">
            Catalyst · Next.js on Cloudflare Workers
          </p>
          <h1 className="max-w-2xl text-4xl font-semibold leading-tight sm:text-5xl">
            Next.js and TypeScript, ready for the edge.
          </h1>
          <p className="max-w-2xl text-lg leading-8 text-slate-700">
            This App Router project uses TypeScript, Tailwind CSS, and vinext so it can run on Cloudflare Workers.
          </p>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-lg border border-slate-200 bg-white p-5">
            ...
            <code className="mt-4 block rounded bg-slate-100 px-3 py-2 text-sm">npm run dev</code>
          </div>
          <div className="rounded-lg border border-slate-200 bg-white p-5">
